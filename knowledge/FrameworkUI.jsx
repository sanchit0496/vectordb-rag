...
const FRAMEWORKS = ['js', 'react', 'angular', 'vue', 'python', 'java', 'c', 'cpp'];
    ...
    useEffect(() => {
        ...
        async function loadFramework() {
            try {
                ...
                const response = await fetch(`/api/v1/frameworks/${framework}`);
...
export default function FrameworkUI() {
    ...
    const { data, loading, error } = useFrameworkData(selectedFramework);
    ...
    return (
        ...
        >
            ...
            <p>Browse engineering standards and framework documentation.</p>
                ...
                {FRAMEWORKS.map((framework) => (
                    <button
                        ...
                        style={{
                            padding: '10px 18px',
                            cursor: 'pointer',
                            background: selectedFramework === framework ? '#2563eb' : '#f1f5f9',
                            color: selectedFramework === framework ? '#fff' : '#000',
